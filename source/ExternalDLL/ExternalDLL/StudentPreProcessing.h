...
public:
	...
	void nonMaximumSuppression(const IntensityImage& image, int* edgeAngles, IntensityImage& output) const;
	void sobelEdgeDetector(const IntensityImage& image, IntensityImage& output, int* angleOutput) const;
